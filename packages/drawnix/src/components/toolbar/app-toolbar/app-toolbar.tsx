...
import { CleanBoard, OpenFile, SaveAsImage, SaveToFile, Settings, BackupRestore, CloudSync, DebugPanel, QuickCommands, UserManual, ChangeLog, VersionInfo, CleanInvalidLinks } from './app-menu-items';
